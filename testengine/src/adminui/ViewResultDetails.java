...
public class ViewResultDetails extends javax.swing.JInternalFrame {

    List<ResultInfoTO> results;

    public ViewResultDetails() {
        initComponents();
        bindTables();
    }

    public void bindTables() {
        results = new ResultInfoDAO().getAllRecord();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("View Student Result Details");
